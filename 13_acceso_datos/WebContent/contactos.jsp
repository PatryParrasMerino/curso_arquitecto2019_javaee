...
<body>
	<%
		...
		List<Contacto> listaContactos=dao.mostrarContactos();
...
<div class="container">
  <table class="table table-striped">
	...
	<%}; %>
    <div class="col-sm-10">
		<button type="button" onclick="window.history.back();" class="btn btn-default"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span> Volver</button>
	</div>
</div>
